...
@section('content')
    ...
    <div class="nav justify-content-center py-1 mb-4">
        <nav class="nav d-flex justify-content-between">
            ...
            <a class="btn btn-light ml-2 mb-2 active" href="" style="background: #b9fb8f">@lang('lang.all')</a>
    ...
    <div class="table-responsive">
        <table class="table" style="background: #f5f5f5;">
            ...
            @forelse($resul_product_complete as $sp)
                <tr>
                    <td class="col-sm-1 text-center"><input type="checkbox" id="item1" name="item[]" readonly="false" value="{{$sp->id}}" checked disabled="true"></td>
                    @if($sp->image == 'default.png')
                        <td class="col-sm-2">
                            <img src="{{URL::to('/uploads/'.$sp->image)}}" style="object-fit: cover;" height="50" width="80"></td>
                        </td>    
                    @else
                        <td class="col-sm-2"><img src="uploads/{{$sp->image}}" style="object-fit: cover;" height="50" width="80"></td>
                    @endif
