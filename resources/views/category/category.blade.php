        ...
        <div class="table">
            <table class="table">
                ...
                <tr>
                    ...
                    <a class="btn btn-success" href="#" data-toggle="modal" data-target="#ModalEdit({{$sp->id}})">@lang('lang.edit')</a>
                        <a href="{{url('category/delete')}}/{{$sp->id}}" class="btn btn-danger">@lang('lang.delete')</a>
                    </td>
                </tr>
                            ...
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    <div class="col-xs-12 col-sm-12 col-md-12">
                                        <div class="form-group">
                                            <strong>@lang('lang.ProductName'):</strong>
